...
>
    <div class="px-3 py-3 lg:px-5 lg:pl-3">
        <div class="flex items-center gap-4">
            <div
                class="flex items-center justify-start rtl:justify-end flex-1 min-w-0"
            >
                <button
                    ...
                    <Dropdown align="auto">
                        {#snippet trigger()}
                            ...
                            >
                                ...
                                <div
                                    class="w-8 h-8 rounded-full bg-orange-500 flex items-center justify-center text-white font-medium"
                                >
                                    {#if authStore.user}
                        ...
                        {#snippet content()}
                            <div
                                class="px-4 py-3 border-b dark:border-gray-600"
                            >
    ...
    {#if isSearchOpen}
        <div class="fixed inset-0 z-50 md:hidden">
            ...
            ></button>
            <div
                class="absolute top-16 left-4 right-4 bg-white dark:bg-gray-900 rounded-xl p-4 shadow-lg border border-gray-100 dark:border-gray-800"
            >
                <LibrarySearchForm
                    onSubmit={handleLibrarySearch}
