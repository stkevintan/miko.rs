        ...
        {#snippet content()}
            <div class="py-1">
                <button
                    ...
                    class="w-full flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 {themeManager.theme ===
                    'light'
                        ? 'bg-orange-50 text-orange-600 dark:bg-gray-800'
                        : ''} cursor-pointer"
                >
