...
<MainLayout>
    <div class="flex flex-col h-[calc(100vh-8rem)]">
        ...
        <!-- Table Container -->
        <div class="flex-1 overflow-hidden bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col relative">
            <DataTable
                data={songs}
                loading={loading}
            >
                ...
                {#snippet row(song)}
                    ...
                    <td class="px-6 py-3 hidden md:table-cell">
                        <span class="text-sm text-gray-600 dark:text-gray-300 line-clamp-1">{song.artist}</span>
                    </td>
                    <td class="px-6 py-3 hidden lg:table-cell">
                        <span class="text-sm text-gray-500 dark:text-gray-400 line-clamp-1">{song.album}</span>
                    </td>
                ...
                {#snippet emptyState()}
                    ...
                    <p class="text-gray-400 text-sm mt-1">Try a different search query</p>
                {/snippet}
            </DataTable>
