...
<div class="min-h-screen bg-gray-50 p-8">
  ...
  <main class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      ...
      <p class="text-gray-600">You are successfully logged in to your Miko Subsonic server.</p>
    </div>
    
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
      <h2 class="text-xl font-semibold mb-2">Music Library</h2>
      <p class="text-gray-600">Your music library is currently being scanned and updated.</p>
    </div>
